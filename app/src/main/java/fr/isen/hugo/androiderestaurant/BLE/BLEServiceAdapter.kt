...
class BLEServiceAdapter(
    bleServices: MutableList<bleService>
) :
    ...
    class CharacteristicViewHolder(itemView: View) : ChildViewHolder(itemView) {
        val characteristicName: TextView = itemView.findViewById(R.id.charasteristiqueName)
        val characteristicUuid: TextView = itemView.findViewById(R.id.charasteristiqueUUID)
    ...
    override fun onCreateChildViewHolder(
        ...
        CharacteristicViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.cell_ble_caracteristique, parent, false)
        )
